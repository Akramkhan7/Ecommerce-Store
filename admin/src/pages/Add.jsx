  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        <textarea
          onClick={() => setDescription(e.target.value)}
          value={description}
          className="w-full max-w-125 px-3 py-2"
          type="text"
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          ...
          <select
            onClick={() => setSubCategory(e.target.value)}
            className="px-2 py-3 w-full"
          >
        ...
        <div>
          ...
          <input
            onClick={() => setPrice(e.target.value)}
            value={price}
      ...
      <button className="bg-black w-28 text-white  py-3 mt-4   cursor-pointer">
        ADD
      </button>
    </form>
  );
